...
for imgIdx = 1:numImages
    ...
    for iter = 1:Max_iter
        ...
        % 顯示當前迭代資訊
        disp(['影像 ', baseName, ' - 迭代 ', num2str(iter), ': a = ', num2str(gather(Alpha_pos(1))), ...
    ...
    % 顯示最佳參數和 PCQI 分數
    disp(['影像 ', baseName, ' - GWO 優化結果（公式 3）：']);
